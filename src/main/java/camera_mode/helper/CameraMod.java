...
public class CameraMod {
    ...
    public static ConfigOpt cameraGeneratesChunks = new ConfigOpt(true);
    ...
    public static String[] configSuggestions = {"cameraGeneratesChunks","canSpectate","canTeleport","consoleLogging","defaultPermissionLevel"};
    public static String[] bool = {"true","false"};
    public static String[] permLevels = {"0","1","2","3","4"};

    static {
        CameraMod.configMaps.put("cameraGeneratesChunks", CameraMod.cameraGeneratesChunks);
        ...
        CameraMod.defaultConfigs.put("cameraGeneratesChunks", CameraMod.cameraGeneratesChunks);
        ...
        CameraMod.typeMaps.put("cameraGeneratesChunks", bool);
