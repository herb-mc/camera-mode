...
public class CameraCommand {
    ...
    public static void swapSurvival(ServerCommandSource source) throws CommandSyntaxException {
        ...
        player.teleport(((ServerPlayerEntityMixinAccess) player).storedWorld(),
                ((ServerPlayerEntityMixinAccess) player).getStoredX(), ((ServerPlayerEntityMixinAccess) player).getStoredY(),
                ((ServerPlayerEntityMixinAccess) player).getStoredZ(), ((ServerPlayerEntityMixinAccess) player).getStoredYaw(),
                ((ServerPlayerEntityMixinAccess) player).getStoredPitch());
